...
(function(root) {
    ...
    if ("undefined" !== Titanium) {
        ...
        exports.Parse = Parse;
    } else if ("undefined" != typeof exports && exports._) {
        Parse._ = exports._.noConflict();
        ...
        "undefined" != typeof localStorage && (Parse.localStorage = localStorage);
        "undefined" != typeof XMLHttpRequest && (Parse.XMLHttpRequest = XMLHttpRequest);
    }
    ...
    Parse._request = function(options) {
        ...
        if (!sessionToken) {
            ...
            currentUser && currentUser._sessionToken && (sessionToken = currentUser._sessionToken);
        }
        if ("batch" !== route && "classes" !== route && "events" !== route && "files" !== route && "functions" !== route && "login" !== route && "push" !== route && "requestPasswordReset" !== route && "rest_verify_analytics" !== route && "users" !== route && "jobs" !== route) throw "Bad route: '" + route + "'.";
        ...
        sessionToken && (dataObject._SessionToken = sessionToken);
    ...
    _.extend(Parse.Promise.prototype, {
        ...
        then: function(resolvedCallback, rejectedCallback) {
            ...
            var wrappedResolvedCallback = function() {
                ...
                resolvedCallback && (result = [ resolvedCallback.apply(this, result) ]);
            ...
            if (this._resolved) wrappedResolvedCallback.apply(this, this._result); else if (this._rejected) wrappedRejectedCallback(this._error); else {
...
(function(root) {
    ...
    var encodeBase64 = function(array) {
        ...
        _.times(chunks.length, function(i) {
            ...
            var has2 = array.length > 3 * i + 1;
            var has3 = array.length > 3 * i + 2;
            chunks[i] = [ b64Digit(63 & b1 >> 2), b64Digit(48 & b1 << 4 | 15 & b2 >> 4), has2 ? b64Digit(60 & b2 << 2 | 3 & b3 >> 6) : "=", has3 ? b64Digit(63 & b3) : "=" ].join("");
        });
        return chunks.join("");
    };
    var mimeTypes = {
    ...
    _.extend(Parse.Object.prototype, Parse.Events, {
        ...
        _refreshCache: function() {
            ...
            Parse._objectEach(this.attributes, function(value, key) {
                value instanceof Parse.Object ? value._refreshCache() : _.isObject(value) && self._resetCacheForKey(key) && self.set(key, new Parse.Op.Set(value), {
                    silent: true
                });
            });
...
(function(root) {
    ...
    Parse.User = Parse.Object.extend("_User", {
        ...
        logOut: function() {
            if (null !== Parse.User._currentUser) {
